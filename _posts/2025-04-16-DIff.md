...
<figure style="text-align: center;">
  <img src="https://kwfredshi.github.io/assets/img/diff/NF.png" alt="Normalizing Flow" style="margin: auto;" width="400"/>
...
<figure style="text-align: center;">
  <img src="https://kwfredshi.github.io/assets/img/diff/ConNF.png" alt="Conditional Normalizing Flow" style="margin: auto;" width="400"/>
  <figcaption style="font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
...
To quote from [^6]: "Creating noise from data is easy; creating data from noise is generative modeling." The diffusion models draw inspirations from stochastic differential equations (SDE) in polluting the data with noise, and recover it using a machine learning model. 

<figure style="text-align: center;">
  <img src="https://kwfredshi.github.io/assets/img/diff/ScoreDiff.png" alt="Score-based Diffusion" style="margin: auto;" width="400"/>
  <figcaption style="font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
