...
<figure style="text-align: center;">
  ...
  <figcaption style="font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    \text{The figure is adapted from } [^1].
  </figcaption>
</figure>
...
<figure style="text-align: center;">
  ...
  <figcaption style="font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    \text{Difference between conditional flow and marginal flow. Marginal here can be seen as the quivalent as what we describe in unconditioned setting.} [^4] [^5].
  </figcaption>
</figure>
...
To quote from [^6]: "Creating noise from data is easy; creating data from noise is generative modeling."
